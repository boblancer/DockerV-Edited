...
class MainWindow(QWidget):
    def __init__(self):
        ...
        )), self.user.getNumberOfImageList(), self.user.getNumberOfVolumeList(), self.listView)
    ...
    def setupMenu(self):
        imageList = [self.home_path, self.dashboard_path,
                     self.containers_path, self.images_path, self.volumes_path]
    ...
    def on_selection_changed(self):
        ...
        if index == 1:
            ...
            )), self.user.getNumberOfImageList(), self.user.getNumberOfVolumeList())
